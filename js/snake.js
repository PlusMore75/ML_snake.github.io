...
let classifier;
// Model URL
let imageModelURL = 'https://teachablemachine.withgoogle.com/models/Eq2DbbhAI/';
    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createWelcomeElement() {
            ...
            welcomeTxt.innerHTML = "JavaScript Snake<p></p>Manten presionada una tecla para detectar la camara. " + fullScreenText + "<p></p>";
